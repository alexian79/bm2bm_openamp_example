...
dow -data J:/projects_ext/validation_study/openamp/openamp.sdk/slave_echo/Debug/slave_echo.elf 0x10000000
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent JTAG-HS2 210249854941"} -index 0
...
dow J:/projects_ext/validation_study/openamp/openamp.sdk/slave_echo/Debug/slave_echo.elf
